...
import { doAdminSignUp } from "../../../store/actions/adminAction/AdminLoginAction";
...
export default function AdminSignup() {
    ...
    const onSubmit = (e) => {
        ...
        dispatch(doAdminSignUp(obj, history, setSpin));
        setName("");
        setCountry("");
        setCity("")
        setEmail("");
    ...
    return (
        <div>
            ...
            <p class="text-center">
                ...
                />
                <span style={{ fontSize: 25, marginLeft: 10 }}>Admin Area</span>
            </p>
